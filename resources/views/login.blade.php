...
<head>
    ...
    <meta charset="utf-8" />
    <meta name="description" content="SENTRA - Sistem Elektronik Naskah & Arsip" />
    <meta name="keywords" content="sentra, surat, naskah, arsip, dinas" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta property="og:locale" content="id_ID" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="SENTRA - Sistem Elektronik Naskah & Arsip" />
            ...
            <div class="d-flex flex-lg-row-fluid">
                ...
                <div class="d-flex flex-column flex-center p-10 w-100">
                    ...
                    <div class="text-gray-600 fs-base text-center">
                        Sistem Elektronik Naskah & Arsip<br>
                        Pengelolaan surat dan arsip yang terintegrasi dan mudah digunakan.
                    </div>
                </div>
                <!--end::Content-->
            </div>
