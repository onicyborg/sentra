<!-- Create Surat Masuk Modal -->
<div class="modal fade" id="createSuratMasukModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">

            <form id="createSuratMasukForm"
                  method="POST"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-5">
                                ...
                                <div class="mt-3" id="c_lampiran_list"></div>
                                <div class="text-muted fs-8 mt-1">
                                    Opsional. Anda dapat menambahkan lampiran tambahan pada proses edit.
                                </div>
                            </div>
                        </div>
                    </div>
